...
/**
 * BLAST (Best Last) for Heterogeneous Ensembles implemented with windowed
 *
 * <p>
...
//			System.out.println(this.ensemble[i]);
			
			//whether this ensemble member's prediction was correct for this instancefad
		...
		if (instancesSeen % gracePerionOption.getValue() == 0) {
			...
			activeClassifierWins[topK.get(0)] += 1;
		}
	}
}
